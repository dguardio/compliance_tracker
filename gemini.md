...
*   **AI & LLM:** `ruby_llm` gem (Google Gemini — `gemini-2.0-flash`, `text-embedding-004`), `nokogiri`, `httparty`, `google_search_results` (SerpAPI)
*   **Vector Search:** `pgvector` via `neighbor` gem
